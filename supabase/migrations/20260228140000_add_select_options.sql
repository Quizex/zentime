-- Add select_options columns to all tables
...
-- Update zentime_replace_my_data function to include select_options
...
-- Update zentime_migrate_state_to_my_tables function to include select_options
