...
begin
  ...
  insert into zentime_categories (
    user_id, id, name, color, default_tags, default_metrics, highlight_pool, pain_point_pool
  )
  select
    v_uid,
    c->>'id',
  ...
  insert into zentime_work_items (
    user_id, id, name, category_id, default_tags, default_metrics, highlight_pool, pain_point_pool, description
  )
  select
    v_uid,
    i->>'id',
  ...
  insert into zentime_events (
    ...
    highlights, pain_points, tags, metrics,
